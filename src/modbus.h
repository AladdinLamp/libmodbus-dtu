...
MODBUS_API int modbus_read_func_registers(modbus_t *ctx, int function, int addr, int nb, uint16_t *dest);
...
MODBUS_API int serial_send_raw_request(modbus_t *ctx, const uint8_t *raw_req, int raw_req_length);

MODBUS_API int serial_receive_msg(modbus_t *ctx, uint8_t *msg, int max_length);

MODBUS_API int receive_645_msg(modbus_t *ctx, uint8_t *msg, int max_length);
...
typedef ssize_t (*modbus_dtu_send)(modbus_t *ctx, const uint8_t *req, int req_length);
typedef ssize_t (*modbus_dtu_recv)(modbus_t *ctx, uint8_t *rsp, int rsp_length);
